...
public abstract class IPoem {
    ...
    // Love
    private static String[] loveW = { "adoration", "affection", "allure", "alluring", 
    ...
    // Death
    private static String[] deathW = { "afterlife", "bereavement", "beyond", "burial", 
    ...
    // Joy
    private static String[] joyW = { "bliss", "celebration", "cheer", "contentment", "delight",
    ...
    // Sadness
    private static String[] sadnessW = { "anguish", "bleak", "blue", "despair", "desolation",
    ...
    public static void setThemesToWords(Map<String, HashSet<String>> themesToWords) {
